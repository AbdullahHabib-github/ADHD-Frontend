...
class _AiChatComponentWidgetState extends State<AiChatComponentWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.chatbotgetResponse = await ChatbotgetCall.call();
      FFAppState().threadId = getJsonField(
        (_model.chatbotgetResponse?.jsonBody ?? ''),
        r'''$.Thread_id''',
      ).toString().toString();
      FFAppState().FirstResponse = getJsonField(
        (_model.chatbotgetResponse?.jsonBody ?? ''),
        r'''$.Response''',
      );
      setState(() {
                    ...
                    Align(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          _model.chatGPTResponse = await ChatbotCall.call(
