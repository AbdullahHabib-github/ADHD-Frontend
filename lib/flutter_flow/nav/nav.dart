...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/learningstyles',
          asyncParams: {
            'pdf': getDocList(['Users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => LearningstylesWidget(
            pdf: params.getParam<UsersRecord>('pdf', ParamType.Document, true),
          ),
        ),
        FFRoute(
          name: 'chatbotgemini',
          path: '/chatbotgemini',
          builder: (context, params) => const ChatbotgeminiWidget(),
        ),
        FFRoute(
          name: 'chatbotgeminiCopy',
          path: '/chatbotaudio',
          builder: (context, params) => const ChatbotgeminiCopyWidget(),
        ),
        FFRoute(
          name: 'ErrorMsg',
          path: '/errorMsg',
        ...
        FFRoute(
          ...
          path: '/googlemap',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'googlemap')
